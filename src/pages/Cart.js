                                ...
                                {products.map((product,index) => (
                                    <div className="cart__product" key={index}>
                                        ...
                                        <div className="cart__price">
                                            <div className="old">{product.price+' сум'}</div>
                                            <div className="new">{product.sale>0?product.price-(product.price*product.sale/100):product.price} сум</div>
                                        </div>
                                        <button 
                        ...
                        <div className="col-4 col-md-12">
                            <div className="cart__all">
                                ...
                                <div className="cart__summa">
                                    ...
                                    <div className="cart__summa--value">{summa} сум</div>
                                </div>
