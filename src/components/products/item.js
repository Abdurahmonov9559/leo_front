...
const Item = ({product,showOneClick}) =>{
    ...
    return (
        <div className={`card ${product._id}`}>
            ...
            <div className="card__category">{product.category.title} ({product.leo ? product.leo : product.gidrox})</div>
            ...
            <div className="card__row mb-2">
                <div className="card__val">
                    ...
                    <div className="card__newprice">{product.price*(100-product.sale)/100} сум</div>
                    <div className="card__sale">
                        <span className="card__percent">{product.sale}%</span>
                        <span className="card__econom">— {new Intl.NumberFormat().format(product.price-product.price*(100-product.sale)/100)} сум</span>
                    </div></>):(
                    <div className="card__newprice">{product.price} сум</div>
                    )}
                </div>
